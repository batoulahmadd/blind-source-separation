...
import add_epy_block_1 as epy_block_1  # embedded python block
import add_epy_block_2 as epy_block_2  # embedded python block
import add_epy_block_2_0 as epy_block_2_0  # embedded python block
import sip



class add(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "add")
...
def main(top_block_cls=add, options=None):
